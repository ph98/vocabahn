...
- Name: review.spec.ts >> Review session >> keyboard shortcuts hint is visible
- Location: e2e/review.spec.ts:84:7
...
Locator: getByText(/arrow keys/i)
Expected: visible
Timeout: 4000ms
...
Call log:
  ...
  - waiting for getByText(/arrow keys/i)
