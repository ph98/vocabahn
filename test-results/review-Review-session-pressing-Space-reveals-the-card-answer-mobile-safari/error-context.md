...
- Name: review.spec.ts >> Review session >> pressing Space reveals the card answer
- Location: e2e/review.spec.ts:61:7
...
Locator: getByRole('button', { name: /show answer/i })
Expected: visible
Timeout: 4000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /show answer/i })
