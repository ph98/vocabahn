...
- Name: dictionary.spec.ts >> Dictionary search (authenticated) >> typing a word shows search results
- Location: e2e/dictionary.spec.ts:70:7
...
- generic [ref=e2]:
  ...
  - main [active] [ref=e5]:
    - navigation "Main" [ref=e6]:
      - link "Vocabahn Home" [ref=e8] [cursor=pointer]:
        - /url: /
        - img "Vocabahn" [ref=e9]
      - link "Dashboard" [ref=e10] [cursor=pointer]:
        - /url: /
      - link "Dictionary" [ref=e14] [cursor=pointer]:
        - /url: /dictionary
      - link "Start review session" [ref=e18] [cursor=pointer]:
        - /url: /review
        - generic [ref=e21]: Review
      - link "Library" [ref=e22] [cursor=pointer]:
        - /url: /library
      - button "Profile navigation options" [ref=e26]:
        - generic [ref=e29]: Profile
    - region "Dashboard" [ref=e31]:
      - heading "Dashboard" [level=2] [ref=e32]
      - paragraph [ref=e33]: Couldn't load your dashboard.
    - generic [ref=e34]:
      - link "v1.0.0" [ref=e35] [cursor=pointer]:
        - /url: https://github.com/ph98/vocabahn/blob/main/docs/changelog.md
      - link "System status" [ref=e36] [cursor=pointer]:
        - /url: /status
        - img "down" [ref=e37]
```
