...
- Name: dictionary.spec.ts >> Dictionary search (authenticated) >> navigating to a word page shows entry detail
- Location: e2e/dictionary.spec.ts:90:7
