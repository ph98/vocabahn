...
- Name: review.spec.ts >> Review session >> shows "all caught up" when no cards are due
- Location: e2e/review.spec.ts:36:7
...
Locator: getByText(/all caught up/i)
Expected: visible
Timeout: 4000ms
...
Call log:
  ...
  - waiting for getByText(/all caught up/i)
