  ...
  return (
    <div className="space-y-3">
      ...
      {sent ? (
        ...
        >
          <label htmlFor="signin-email" className="text-sm text-surface-400">
            Sign in with email
          </label>
          <div className="flex gap-2">
            <input
              ...
              className="min-h-11 flex-1 rounded-xl border border-surface-700 bg-surface-950 px-4 text-sm placeholder:text-surface-500 transition-colors focus:border-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            />
            <button
              type="submit"
