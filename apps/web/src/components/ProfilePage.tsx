...
export function ProfilePage() {
  ...
  return (
    ...
    >
      <h2 className="mb-4 text-sm font-medium uppercase tracking-wide text-neutral-400">Profile</h2>
        ...
        <div className="flex items-center gap-4">
          {user.avatarUrl && (
            <img
              ...
              className="size-11 rounded-full ring-2 ring-neutral-800"
            />
          )}
          ...
          <button
            ...
            className="min-h-11 rounded-xl border border-neutral-700 px-4 text-sm transition-colors hover:border-neutral-600 hover:bg-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
          >
            Sign out
          </button>
        </div>
