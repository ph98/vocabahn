...
- **AI-First & MCP Architecture**: Understand that this app combines FSRS with LLM enrichment and supports Model Context Protocol (MCP). Check `docs/architecture.md` for architectural context.
